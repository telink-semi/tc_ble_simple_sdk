 ...
 */
#define B80_SDK_VERSION_NUM				CERTIFICATION_MARK.SOFT_STRUCTURE.MAJOR_VERSION.MINOR_VERSION

#define SDK_VERSION_NUM					B80_SDK_VERSION_NUM

#define	SDK_VERSION1(sdk_version_num)	"$$$tc_ble_simple_sdk_"#sdk_version_num"$$$"
