...
typedef enum{
	 ...
	 * 		System data is stored above 384K. User data must stored above 384K too.
	 *      If using Telink OTA, low 128K area is used for both raw firmware and new firmware storage.
	 *      If user data stored below 128K, please do not use reference code, but design and implement by themselves. */
