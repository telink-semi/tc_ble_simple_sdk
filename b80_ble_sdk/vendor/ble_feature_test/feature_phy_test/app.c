...
int tx_to_uart_cb(void) {
	...
	Tr_clrUartTxDone();
	uart_send_dma(UART_CONVERT((unsigned char*) (&uart_txdata_buf)));
...
void app_uart_init(void)
{
	...
	uart_gpio_set(UART_CONVERT(UART_TX_PIN, UART_RX_PIN));  // uart tx/rx pin set
	uart_reset(UART_NUM); //uart module power-on again.
